...
"""
PROTOCOL = 'basketball-intrinsic20/v1'
INTRINSIC_LIMIT = .20
EXCLUDED = (4, 5, 8, 11, 15, 16, 17, 18, 20, 23)
HELD_OUT = (0, 10, 30)
...
def manifest_protocol():
    return dict(schema=PROTOCOL, cameras=list(CAMERAS), training_cameras=list(TRAINING),
                ...
                exclusion_reason='User restored the 20% limit and excluded failures from the completed ten-frame test; camera 5 remains excluded.',
