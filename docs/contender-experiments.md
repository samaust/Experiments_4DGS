...
[Plan 012 exact-Hessian pilot](experiments/basketball-shared-timing-v6.md) ends at `numerical_failure`: the curvature diagnostic passed, but only 94/144 pilot attempts qualified (72 regularized, 22 data-only). No later scientific stage or new selection/final-frame consumption ran; accepted timing remains null.
