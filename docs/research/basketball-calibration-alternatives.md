...
Results and the eventual recommendation belong to the [measured experiment](../experiments/basketball-calibration-alternatives.md).
...
| Route | Code | Weights |
| --- | --- | --- |
| COLMAP / frontend | COLMAP BSD-3-Clause; LightGlue Apache-2.0; inspect separate bundled SuperPoint terms | SuperPoint and LightGlue upstream released weights; checkpoint hashes recorded separately |
